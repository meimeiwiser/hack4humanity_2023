...
def test():
    ...
    url = "https://api.yelp.com/v3/businesses/search?term={}&location={}".format(specialist, location)
    params ={}
    headers = {
                    'Authorization': 'Bearer {}'.format(config.YELP_TOKEN)
    }
...
def get_def_dict(symptoms):
    ...
    return dept_def_ret
print(get_def_dict("I have pain in my left chest"))
